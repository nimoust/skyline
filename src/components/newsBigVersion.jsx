...
export default function NewsBigVersion() {
    return (
        <div className="max-w-[1090px] min-h-[678px] flex flex-col justify-center items-center text-center bg-white rounded-[12px] shadow m-4 hover:bg-gray-50 overflow-hidden">
            ...
            <div className="w-full flex flex-col justify-between leading-normal text-[16px] flex-1">
                <div className="flex flex-col justify-center items-center text-center p-6">
                    <h5 className="mb-12 mt-6 text-black font-lato font-[700] text-[40px] leading-[48px]">TITLE</h5>
